...
export const products: Product[] = [
...

  {
    ...
    description:
      "Emma's Original Lite is a 22cm all-foam mattress with the brand's Airgocell open-cell foam and a cold-process memory foam comfort layer. It is built for combination sleepers who want a responsive surface that still cushions pressure points, and the lighter profile makes it a sensible fit for average-weight sleepers who prefer an easier-turning feel.",
...

  {
    ...
    description:
      "Nectar's entry hybrid pairs 20cm of memory foam comfort with a supportive spring base. The result is a balanced medium feel with enough contouring for side sleeping and enough bounce for combination sleepers. It is a good entry point if you want hybrid support and a recognisable brand without jumping straight into premium pricing.",
...

  {
    ...
    description:
      "Nectar's Classic Hybrid combines cooling memory foam with individually pocketed springs in a 25cm profile. The medium-firm feel and reinforced edges make it especially appealing to couples and back sleepers who want zone support, better edge use, and less motion transfer than a traditional spring mattress.",
...

  {
    ...
    description:
      "Otty's Original Hybrid 2000 uses a cooling gel-foam comfort layer, bamboo-charcoal memory foam, and up to 2,000 individually pocketed micro-springs. The open-cell structure helps it breathe better than a dense all-foam mattress, while the balanced medium feel keeps it versatile for mixed-position sleepers who run warm.",
...

  {
    ...
    description:
      "Dormeo's Octasmart Hybrid combines Octaspring foam-spring technology with Aerocell foam and a pocket-spring base. It is one of the stronger premium choices for hot sleepers who want zoned support and responsive pressure relief without the noise and bounce of a traditional metal spring mattress.",
...

  {
    ...
    description:
      "Simba's flagship 28cm hybrid combines graphite-infused Simbatex cooling foam, open-cell memory foam, and up to 5,000 individually pocketed aerocoil springs. It is the most engineered option in the catalogue, with strong zone support, excellent motion control, and active heat dissipation for sleepers who want a premium all-rounder.",
