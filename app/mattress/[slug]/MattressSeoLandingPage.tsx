...
const quickBuyIntroBySlug: Record<string, string> = {
  "best-mattress-for-side-sleepers": "For side sleepers, this is a strong general-fit starting pick before you fine-tune in the quiz.",
  "best-mattress-for-back-pain": "For back-pain shoppers, this is a strong general-fit baseline focused on support and alignment.",
  "best-mattress-for-heavy-people": "For heavier sleepers, this is a strong general-fit starting option prioritising structure and durability.",
  "best-mattress-for-couples": "For couples, this is a strong general-fit starting option for motion control and shared comfort.",
  "best-cooling-mattress": "For hot sleepers, this is a strong general-fit starting pick focused on airflow and heat control.",
  "best-hybrid-mattress": "For hybrid buyers, this is a strong general-fit starting pick balancing foam comfort and spring support.",
  "best-budget-mattress": "For budget shoppers, this is a strong general-fit baseline focused on support-per-pound value.",
  "best-mattress-under-500": "For under-GBP500 buyers, this is a strong general-fit starting pick before deeper fit refinement.",
};
...
function buildDefaultQuickVerdict(page: MattressSeoPage): string[] {
  ...
  return [
    ...
    "Revisit your mattress choice once your sleep needs change, not just when discounts appear.",
  ];
}

function buildDefaultToc(page: MattressSeoPage): Array<{ label: string; href: string }> {
...
function buildDefaultMethodology(page: MattressSeoPage): string {
  return `We rank these options by fit for ${page.breadcrumbLabel.toLowerCase()}, combining support profile, temperature behavior, and value for money. The goal is to improve comfort and overnight consistency first, then refine preference details.`;
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: 13, color: TEXT2, lineHeight: 1.7 }}>
          <strong>Quiz</strong> is better if you want us to weigh up your sleep position, support needs, temperature preference and budget before recommending a mattress.
        </p>
        <Link
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: 13, color: TEXT2, lineHeight: 1.5 }}>
          {quickBuyIntroBySlug[pageSlug] ?? "This is the preset Quick Buy choice for this topic."}
        </p>
...
export default function MattressSeoLandingPage({ page }: { page: MattressSeoPage }) {
  ...
  const related = page.relatedSlugs
    .map((slug) => mattressSeoPageMap[slug])
    .filter((relatedPage): relatedPage is MattressSeoPage => Boolean(relatedPage));
    ...
    <div style={{ width: "100%", background: SURFACE }}>
      ...
      >
        <article>
          ...
          {quickBuy ? <QuickBuySection pageSlug={page.slug} /> : null}
          ...
          <section style={cardStyle}>
            ...
            <p style={bodyStyle}>
              ...
              start with our central best mattress page.
            </p>
            <Link
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: 15, color: "rgba(255,255,255,0.75)", lineHeight: 1.55 }}>
              ...
              your sleep position, support needs and budget.
            </p>
          ...
          >
            ...
            our verified mattress catalogue changes.
          </p>
        </article>
